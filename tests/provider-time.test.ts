...
describe("optional provider time", () => {
  it("declares clock sampling only through explicit support", () => {
    const manifest = { id: "provider", displayName: "Provider", channel: "voice", supportedProtocolVersions: [1], authenticationMethods: ["credentials"], disposalSettleMs: 5000, phones: ["softphone"] };
